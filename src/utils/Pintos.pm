...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("/home/binhku2610/Pintos/src/userprog/build/loader.bin") if !defined $name;
    # $name = find_file ('/home/gs201/Desktop/pintos/src/threads/build/loader.bin') if !defined $name;
    # $name = find_file ('/home/gs201/Desktop/pintos/src/userprog/build/loader.bin') if !defined $name;
